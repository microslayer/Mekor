...
var TanachObj = {
   TanachNameNumberMap : TanachNameNumberMap, 
   TanachKeyNum : TanachKeyNum, 

   getBookNum : function(param) {
      if (isNaN(param)) 
      {
         return TanachNameNumberMap[param]; 
      }
      else 
         return param; 
   }, 
...
function createTanachKeyNum() {
   ...
   var TanachKeyNum = {}
   for (key in TanachNameNumberMap)
    TanachKeyNum[TanachNameNumberMap[key]] = key
...
TanachSource.prototype = {
	constructor: TanachSource(book, chapter, verse) {
		if (isNaN(book))
